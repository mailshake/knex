  ...
  Migrator.prototype._listAll = function _listAll(config) {
    ...
    return _bluebird2.default.promisify(_fs2.default.readdir, { context: _fs2.default })(this._absoluteConfigDir()).then(function (migrations) {
      return (0, _filter3.default)(migrations, function (value) {
        ...
        var customExt = void 0;

        // Check for two part extensions (like .d.ts)
        var filenameArray = _path2.default.basename(value).split('.');
        if (filenameArray.length > 2) {
          var _customExt = '.' + filenameArray.slice(filenameArray.length - 2).join('.');
          extension = _customExt;
        }

        console.log('File: ' + value + ', ext: ' + extension + ', filenameArray: ' + (0, _stringify2.default)(filenameArray, null, 2) + ', customExt: ' + customExt);
